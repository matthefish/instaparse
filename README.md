...
## Examples
### getprofile()
This will return profile data like followers, following, is_verified etc.
```py
import instaparse
...
### getpost(index)
getpost will return the post you choose. Getpost can only retrieve up to the 7th most recent picture.
```py
import instaparse
